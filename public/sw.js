const CACHE = 'sod-shell-v3.9999-final-shell';
const SHELL = ['/', '/index.html', '/styles.css', '/manifest.webmanifest', '/offline.html', '/js/app.js', '/js/views.js', '/js/content.js', '/js/seed-market-data.js', '/js/dashboard-data.js', '/js/library-data.js', '/js/store.js', '/js/api.js', '/js/router.js', '/js/hub-scene.js', '/js/audio.js', '/js/visual-assets.js', '/js/conversation-controller.js', '/js/session-provider.js', '/assets/remote-visuals.json'];
