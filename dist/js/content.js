...
const universeSpecs = [
  {slug:'sod',title:'Hablar con SØD',shortDescription:'Ordená lo que ocupa tu mente y convertí confusión en una comprensión posible.',humanNeed:'Necesito comprender qué pienso, qué siento o qué debería hacer.',entryQuestion:'¿Qué está ocupando tu mente en este momento?',icon:'Ø',color:'#79E8FF',message:'No vine a decidir por vos. Vine a ayudarte a observar mejor.',visual:visual('035'),destination:'/experiencia',type:'transformational'},
  {slug:'seeds',title:'Semillas',shortDescription:'Explorá colecciones de conocimiento vivo. Elementos es la primera colección SØD.',humanNeed:'Necesito descubrir comprensiones que acompañen mi evolución.',entryQuestion:'¿Qué colección querés explorar hoy?',icon:'✦',color:'#69E9A5',message:'Las Semillas ya existen. Tu recorrido determina cuándo estás preparado para descubrirlas.',visual:visual('036'),destination:'/semillas',type:'marketplace'},
  {slug:'habits',title:'Hábitos',shortDescription:'Marcá tus hábitos diarios, editá tu rutina y convertí metas en sistemas sostenibles.',humanNeed:'Necesito sostener aquello que sé que me hace bien.',entryQuestion:'¿Qué querés sostener hoy?',icon:'↻',color:'#8BE07D',message:'La disciplina no es castigo. Es una estructura que protege lo que elegiste.',visual:visual('059'),destination:'/habitos',type:'daily-loop'},
  ...
  {slug:'observatory',title:'Dashboard',shortDescription:'Observá métricas, evolución, sueños y señales del recorrido sin convertir tu vida en una planilla.',humanNeed:'Necesito ver qué está cambiando y hacia dónde estoy yendo.',entryQuestion:'¿Qué historia está contando mi recorrido?',icon:'✺',color:'#7EF0D6',message:'Los datos no son el objetivo. Son otra forma de volver visible lo que antes era invisible.',visual:visual('038'),destination:'/dashboard',type:'observatory-dashboard'},
